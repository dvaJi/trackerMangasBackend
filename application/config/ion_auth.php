 ...
 */
$config['site_title']                 = "TrackerMangas";       // Site Title, example.com
$config['admin_email']                = "nocontestar@mangatrackers.website"; // Admin Email, admin@example.com
...
$config['forgot_password_expiration'] = 7200000;                   // The number of milliseconds after which a forgot password request will expire. If set to 0, forgot password requests will not expire.
